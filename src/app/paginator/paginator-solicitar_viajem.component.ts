...
@Component({
  selector: 'paginator-nav-paginator-solicitar',
  templateUrl: './paginator-solicitar_viajem.component.html',
})
export class PaginatorSolicitarViajemComponent implements OnInit, OnChanges {
