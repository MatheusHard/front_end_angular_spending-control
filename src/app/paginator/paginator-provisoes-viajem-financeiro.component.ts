...
@Component({
  selector: 'paginator-nav-provisoes-viajem-financeiro',
  templateUrl: './paginator-provisoes-viajem-financeiro.component.html',
})
export class PaginatorProvisoesViajemFinanceiroComponent implements OnInit, OnChanges {
//provisoes_viajem_financeiro
