...
@Injectable({
 ...
 getFuncionarios(page: number): Observable<any> {
  ...
  create(funcionario: Funcionario) : Observable<any>{
    return this.http.post<any>(`${this.URL_BASE}${this.URL_FUNCIONARIO}`, funcionario, {headers: this.httpHeaders}).pipe(
       catchError(e => {
  ...
  update(funcionario: Funcionario): Observable<any>{
    return this.http.put<any>(`${this.URL_BASE}${this.URL_FUNCIONARIO}/${funcionario.id}`, funcionario, {headers: this.httpHeaders}).pipe(
      catchError(e => {
...
/*********DELETE FUNCIONARIO*********/
 ...
 delete(id: number): Observable<any>{
   return this.http.delete<any>(`${this.URL_BASE}${this.URL_FUNCIONARIO}/${id}`, {headers:this.httpHeaders});
 }
